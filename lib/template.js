...
function Template() {
  ...
  this.pluginConfirms = {
    ...
    redis: 'need redis(y/n)?',
    logger: 'need logger(y/n)?',
    socketIo: 'need socket.io(y/n)?',
    restfulWrap: 'need restful wrap(y/n)?'
  };
  this.values = {};
  this.plugins = {};
  this.directories = {};
...
Template.prototype.init = function(dest, templatesPath) {
  this.contentPath = templatesPath || join(__dirname, '..', 'template');
  var self = this;
  var vars = this.vars;
